...
A PowerShell-based automation solution that monitors self signed and SP certificate expiration dates in PingFederate connections and proactively notifies application owners before certificates expire.
## Overview
